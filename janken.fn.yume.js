...
export const __block = {
  ...
  "versions": [
    ...
    },
    {
      ...
      "applyId": "apply-2026-05-27-51b6f8a5",
      "hash": "a13d655dbef7a143096331d71825ae51ea4e56ec9afd13a05fe8d95177a850e0",
      "prevHash": "a72b01718a2dac41c3d49d45c629b80bde1b1d4efb6798cdc4c52017277f6d52"
    }
  ],
  "notes": {
    "apply:apply-2026-05-27-51b6f8a5": [
      {
        "id": "n-05a80a9a-b5d8-4855-a6b7-e8288a323f42",
        "author": "human",
        "ts": 1779867863051,
        "text": "add @tags: standalone example constraint-folding"
      }
    ]
  }
};
...
// === HEAD ===
// @tags: standalone example constraint-folding
// Author: 沖井広行 (Hiroyuki OKINOI) / Pen name: 蒼山りと (Aoyama Rito)
// SPDX-License-Identifier: MIT
